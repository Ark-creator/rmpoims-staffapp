        ...
        <View style={styles.inputContainer}>
          ...
          >
            <Ionicons 
              name="send" 
              size={24} 
              color={(!newMessage.trim() && !fileToSend) ? COLORS.textLight : COLORS.primary} 
            />
          </TouchableOpacity>
        </View>
      </>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.modeTabs}>
            <TouchableOpacity 
              style={[
                styles.modeTab,
                chatMode === 'direct' && styles.activeModeTab
              ]}
              onPress={() => setChatMode('direct')}
            >
              <Text style={[
                styles.modeTabText,
                chatMode === 'direct' && styles.activeModeTabText
              ]}>
                Direct
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              style={[
                styles.modeTab,
                chatMode === 'group' && styles.activeModeTab
              ]}
              onPress={() => setChatMode('group')}
            >
              <Text style={[
                styles.modeTabText,
                chatMode === 'group' && styles.activeModeTabText
              ]}>
                Group
              </Text>
            </TouchableOpacity>
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={[
                      styles.contactItem,
                      selectedUser?.id === item.id && styles.selectedContactItem
                    ]}
                    onPress={() => {
